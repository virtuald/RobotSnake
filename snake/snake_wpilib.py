...
class SnakeWatchdog(object):
    ...
    def __init__(self):
        ...
        self.fed = None
        self.alive = True
        self.expiration = SnakeWatchdog.kDefaultWatchdogExpiration
